...
public class GatewayAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (gatewayApiKey == null || !gatewayApiKey.equals(configuredGatewayKey)) {
            log.warn("Rejected fine request without valid gateway key. path={}", request.getRequestURI());
        ...
        if (isBlank(userId) || isBlank(userEmail) || isBlank(userRole)) {
            log.warn("Rejected fine request with missing auth context. path={}, userId={}, userEmail={}, userRole={}",
