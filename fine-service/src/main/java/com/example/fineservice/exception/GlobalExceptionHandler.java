...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleLibraryServiceException(LibraryServiceException ex, HttpServletRequest request) {
        log.error("Library service integration error at {}: {}", request.getRequestURI(), ex.getMessage(), ex);
        return buildErrorResponse(HttpStatus.BAD_GATEWAY, "LIBRARY_SERVICE_ERROR", ex.getMessage(), request.getRequestURI());
    }
    ...
    public ResponseEntity<ApiErrorResponse> handleConstraintViolation(ConstraintViolationException ex, HttpServletRequest request) {
        log.warn("Constraint validation failed at {}: {}", request.getRequestURI(), ex.getMessage());
